@{
    ...
    "^/iocs/(entities|queries)/indicators/" = "\w{64}"
    ...
    "^/recon/entities/actions/" = "\w{8}-\w{4}-\w{4}-\w{4}-\w{12}"
    "^/recon/entities/notifications(-detailed|-detailed-translated|-translated)?/" = "\w{76}"
