@{
  ...
  FunctionsToExport = @(
    ...
    # data-protection
    'Edit-FalconDpeAccount'
    'Edit-FalconDpeApplication'
    'Edit-FalconDpeClassification'
    'Edit-FalconDpeLocation'
    'Edit-FalconDpePattern'
    'Edit-FalconDpePolicy'
    'Get-FalconDpeAccount'
    'Get-FalconDpeApplication'
    'Get-FalconDpeClassification'
    'Get-FalconDpeLabel'
    'Get-FalconDpeLocation'
    'Get-FalconDpePattern'
    'Get-FalconDpePolicy'
    'Get-FalconDpeType'
    'New-FalconDpeAccount'
    'New-FalconDpeApplication'
    'New-FalconDpeClassification'
    'New-FalconDpeLabel'
    'New-FalconDpeLocation'
    'New-FalconDpePattern'
    'New-FalconDpePolicy'
    'Remove-FalconDpeAccount'
    'Remove-FalconDpeApplication'
    'Remove-FalconDpeClassification'
    'Remove-FalconDpeLabel'
    'Remove-FalconDpeLocation'
    'Remove-FalconDpePattern'
    'Remove-FalconDpePolicy'
  ...
  PrivateData = @{
    PSData = @{
      ...
      ReleaseNotes = 'https://github.com/crowdstrike/psfalcon/releases/tag/2.3.0'
    }
  }
}