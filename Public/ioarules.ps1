...
#>
    ...
    [OutputType('PSFalcon.api.RuleGroupV1',ParameterSetName='/ioarules/entities/rule-groups/v1:patch')]
    param(
...
#>
    ...
    [OutputType('PSFalcon.api.RuleV1',ParameterSetName='/ioarules/entities/rules/v1:patch')]
    param(
...
#>
    ...
    [OutputType('PSFalcon.api.RuleGroupV1',ParameterSetName='/ioarules/entities/rule-groups/v1:get')]
...
#>
    ...
    [OutputType('PSFalcon.domain.Platform',ParameterSetName='/ioarules/entities/platforms/v1:get')]
...
#>
    ...
    [OutputType('PSFalcon.api.RuleV1',ParameterSetName='/ioarules/entities/rules/GET/v1:post')]
...
#>
    ...
    [OutputType('PSFalcon.api.PatternV1',ParameterSetName='/ioarules/entities/pattern-severities/v1:get')]
...
#>
    ...
    [OutputType('PSFalcon.api.RuleTypeV1',ParameterSetName='/ioarules/entities/rule-types/v1:get')]
...
#>
    ...
    [OutputType('PSFalcon.api.RuleGroupV1',ParameterSetName='/ioarules/entities/rule-groups/v1:post')]
    param(
...
#>
    ...
    [OutputType('PSFalcon.api.RuleV1',ParameterSetName='/ioarules/entities/rules/v1:post')]
    param(
...
#>
    ...
    [OutputType('PSFalcon.msa.ReplyMetaOnly',ParameterSetName='/ioarules/entities/rule-groups/v1:delete')]
    param(
...
#>
    ...
    [OutputType('PSFalcon.msa.ReplyMetaOnly',ParameterSetName='/ioarules/entities/rules/v1:delete')]
    param(
...
#>
    ...
    [OutputType('PSFalcon.domain.FieldValidation',ParameterSetName='/ioarules/entities/rules/validate/v1:post')]
    param(
