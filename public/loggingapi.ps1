...
https://github.com/crowdstrike/psfalcon/wiki/New-CommandName
#>
  [CmdletBinding(DefaultParameterSetName='/loggingapi/entities/saved-searches-dynamic-execute/v1:post',SupportsShouldProcess)]
  param(
    [Parameter(ParameterSetName='/loggingapi/entities/saved-searches-dynamic-execute/v1:post',Position=0)]
    [Alias('app_id')]
    [string]$AppId,
    [Parameter(ParameterSetName='/loggingapi/entities/saved-searches-dynamic-execute/v1:post',Position=0)]
