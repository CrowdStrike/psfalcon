...
function Get-FalconDiscoverNetwork {
<#
.SYNOPSIS
...
Display total result count instead of results
.LINK
https://github.com/crowdstrike/psfalcon/wiki/Get-FalconDiscoverNetwork
#>
    [CmdletBinding(DefaultParameterSetName='/discover/queries/active-discovery-networks/v1:get',
    ...
    param(
        ...
        [string]$Sort,
        [Parameter(ParameterSetName='/discover/queries/active-discovery-networks/v1:get',Position=3)]
        [ValidateRange(1,100)]
        [int]$Limit,
        [Parameter(ParameterSetName='/discover/queries/active-discovery-networks/v1:get')]
        [int]$Offset,
        [Parameter(ParameterSetName='/discover/queries/active-discovery-networks/v1:get')]
        [switch]$All,
        [Parameter(ParameterSetName='/discover/queries/active-discovery-networks/v1:get')]
    ...
    begin {
        $Param = @{
            Command = $MyInvocation.MyCommand.Name
            Endpoint = $PSCmdlet.ParameterSetName
            Format = @{ Query = @('offset','sort','limit','filter') }
        }
    }
    process { Invoke-Falcon @Param -Inputs $PSBoundParameters }
}
function Get-FalconDiscoverRule {
<#
.SYNOPSIS
...
Display total result count instead of results
.LINK
https://github.com/crowdstrike/psfalcon/wiki/Get-FalconDiscoverRule
#>
    [CmdletBinding(DefaultParameterSetName='/discover/queries/active-discovery-rules/v1:get',
        SupportsShouldProcess)]
    param(
        ...
        [string]$Sort,
        [Parameter(ParameterSetName='/discover/queries/active-discovery-rules/v1:get',Position=3)]
        [ValidateRange(1,100)]
        [int]$Limit,
        [Parameter(ParameterSetName='/discover/queries/active-discovery-rules/v1:get')]
        [int]$Offset,
        [Parameter(ParameterSetName='/discover/queries/active-discovery-rules/v1:get')]
        [switch]$All,
        [Parameter(ParameterSetName='/discover/queries/active-discovery-rules/v1:get')]
...
Display total result count instead of results
.LINK
https://github.com/crowdstrike/psfalcon/wiki/Get-FalconDiscoverScan
#>
    [CmdletBinding(DefaultParameterSetName='/discover/queries/active-discovery-scans/v1:get',
        SupportsShouldProcess)]
    param(
        ...
        [string]$Sort,
        [Parameter(ParameterSetName='/discover/queries/active-discovery-scans/v1:get',Position=3)]
        [ValidateRange(1,100)]
        [int]$Limit,
        [Parameter(ParameterSetName='/discover/queries/active-discovery-scans/v1:get')]
        [int]$Offset,
        [Parameter(ParameterSetName='/discover/queries/active-discovery-scans/v1:get')]
        [switch]$All,
        [Parameter(ParameterSetName='/discover/queries/active-discovery-scans/v1:get')]
...
Display total result count instead of results
.LINK
https://github.com/crowdstrike/psfalcon/wiki/Get-FalconDiscoverScanner
#>
    [CmdletBinding(DefaultParameterSetName='/discover/queries/active-discovery-scanners/v1:get',
        SupportsShouldProcess)]
    param(
        ...
        [string]$Sort,
        [Parameter(ParameterSetName='/discover/queries/active-discovery-scanners/v1:get',Position=3)]
        [ValidateRange(1,100)]
        [int]$Limit,
        [Parameter(ParameterSetName='/discover/queries/active-discovery-scanners/v1:get')]
        [int]$Offset,
        [Parameter(ParameterSetName='/discover/queries/active-discovery-scanners/v1:get')]
        [switch]$All,
        [Parameter(ParameterSetName='/discover/queries/active-discovery-scanners/v1:get')]
