...
#>
  [CmdletBinding(DefaultParameterSetName='/spotlight/combined/vulnerabilities/v1:get',SupportsShouldProcess)]
  param(
  ...
  begin {
    ...
    if ($PSBoundParameters.All -and !$PSBoundParameters.Limit) { $PSBoundParameters['Limit'] = 5000 }
  }
  process { Invoke-Falcon @Param -UserInput $PSBoundParameters }
}
